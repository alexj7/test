...
export const POST: RequestHandler = async ({ request }) => {
	try {
		...
		console.error(err)
		return json({ error: 'There was an error processing your request', message: err }, { status: 500 })
	}
}
